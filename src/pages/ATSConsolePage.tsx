...
import { Cpu, CheckCircle2, XCircle, AlertTriangle, ArrowRight, ShieldAlert, Sparkles } from 'lucide-react';

export const ATSConsolePage: React.FC = () => {
  const { atsDiagnostic, activeJobTarget, verifySkill, setActiveScreen } = useCareer();
        ...
        <div className="flex items-center gap-4">
          <div className="px-6 py-3 rounded-2xl bg-[#111822] border border-[#35C6FF]/50 text-center shadow-[0_0_20px_rgba(53,198,255,0.2)]">
            <div className="font-mono text-4xl font-extrabold text-[#F3F5F7]">
              {atsDiagnostic.overallScore}
            </div>
            <div className="text-[10px] font-mono text-[#35C6FF] uppercase tracking-wider">ATS MATCH SCORE</div>
          </div>
